...
jsPsych.plugins['image-multi-select'] = (function() {
  var plugin = {};
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-select-question { margin-top: 2em; margin-bottom: 2em; text-align: center; }" +
      ...
      ".jspsych-survey-multi-select-horizontal .jspsych-survey-multi-select-text {  text-align: center; margin-left: 0.5em}"+
    ...
    if (trial.stimulus !== null) {
        // display stimulus
        trial_form.innerHTML += '<img style="width: 80%;" src="' + trial.stimulus + '" id="jspsych-image-multi-select-response-stimulus"/>';
    }
