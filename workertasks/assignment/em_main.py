...
if __name__ == "__main__":
    ...
    # datafile = sys.argv[1]
    data = [["q1","w2","1"], ["q2","w2","1"],["q1","w1","2"],["q3","w2","2"]]
    e2wl,w2el,label_set = gete2wlandw2el(data) # generate structures to pass into EM

    iterations = 20 # EM iteration number
    initquality = {'w1':0.7,'w2':0.7}
